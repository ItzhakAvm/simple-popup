...
class ErrorResponse extends SimpleResponse
{
    ...
    {
        return <<<EOT
            <h1>{$code} {$this::STATUS_CODES[$code]}</h1>
            If this problem continues, it's probably because Itzhak is on a coffee break.
            EOT;
    }
}